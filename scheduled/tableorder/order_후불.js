...
describe('TableOrder 후불 Test', function () {
    ...
    before(
        ...
        run(async () => {
            driver = await remote(
                tableorder(4727, env.GalaxyTabS7FE.deviceName, `${env.GalaxyTabS7FE.udid}${'35331'}`),
            );
